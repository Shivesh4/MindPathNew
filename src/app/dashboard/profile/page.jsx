              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <div className="text-muted-foreground text-sm italic">
                    Add subjects you're interested in to get personalized recommendations
                  </div>
                )}
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  {isEditing && (
                    <span className="text-xs text-muted-foreground">Tell us about yourself</span>
                  )}
                </div>
                {isEditing ? (
                  <Textarea
                    ...
                    value={editForm.bio}
                    onChange={handleInputChange}
                    placeholder="Share your interests, goals, and what you're looking for in a tutoring experience"
                    rows={4}
                  />
                ) : profile.bio ? (
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    ...
                    <div className="text-muted-foreground text-sm py-2 italic">
                      Add your major or field of study
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    <Input
                      ...
                      value={editForm.year}
                      onChange={handleInputChange}
                      placeholder="e.g., Freshman, Sophomore, Senior"
                    />
                  ) : profile.year ? (
                    <p className="text-sm py-2">{profile.year}</p>
                  ) : (
                    <div className="text-muted-foreground text-sm py-2 italic">
                      Add your academic year
                    </div>
                  )}
                </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  {isEditing && (
                    <span className="text-xs text-muted-foreground">Add subjects you're studying</span>
                  )}
                </div>
                {isEditing ? (
                  <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {profile.subjects && profile.subjects.length > 0 ? (
                      ...
                      <div className="text-muted-foreground text-sm italic">
                        Add subjects you're currently studying to get personalized tutoring recommendations
                      </div>
                    )}
                  </div>
                )}
